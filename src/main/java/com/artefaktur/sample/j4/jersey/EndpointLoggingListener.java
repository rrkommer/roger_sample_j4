...
public class EndpointLoggingListener implements ApplicationEventListener
{
  ...
  private static class ResourceLogDetails
  {
    ...
    private static final Logger logger = Logger.getLogger(ResourceLogDetails.class);

    private static final Comparator<EndpointLogLine> COMPARATOR = Comparator.comparing((EndpointLogLine e) -> e.path)
